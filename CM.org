...
[refaire les démonstrations par récurrence]
...
- FB_n a n noeuds
- FB_n a (n - \nu(n)) arêtes (les noeuds, moins le nombre de tournois)
...
Ces primitives des pages 22 et 23 sont utilisables en examen : si on les appelle dans du pseudo-code, le correcteur saura ce que ça signifie.
...
Cout de la construction est le cout de la commutation de bits.
